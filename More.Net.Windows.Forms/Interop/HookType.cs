namespace More.Net.Windows.Forms.Interop
{
    ...
    public enum HookType : int
    {
        ...
        /// event in a dialog box, message box, menu, or scroll bar. For more information, see the 
        ...
        /// <summary>
        /// Installs a hook procedure that monitors keystroke messages. For more information, see 
        /// the KeyboardProc hook procedure.
        /// </summary>
        WH_KEYBOARD = 2,
        /// <summary>
        ...
        WH_CALLWNDPROC = 4,
        /// <summary>
        /// Installs a hook procedure that receives notifications useful to a CBT application. For 
        ...
        /// these messages for all applications in the same desktop as the calling thread. For more 
        ...
        WH_DEBUG = 9,
        /// <summary>
        /// Installs a hook procedure that receives notifications useful to shell applications. For 
        ...
        /// destination window procedure. For more information, see the CallWndRetProc hook 
        /// procedure.
        /// </summary>
