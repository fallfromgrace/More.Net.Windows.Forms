...
namespace More.Net.Windows.Forms.Interop
{
    ...
    public struct HRESULT : IComparable, IComparable<HRESULT>, IEquatable<HRESULT>
    {
        ...
        public HRESULTSeverity Severity
        {
            get;
            set;
        }

        public HRESULTCustomer Customer
        {
            get
            {
                if ((value & 0x10000000) > 0)
                    return HRESULTCustomer.Customer;
                else
                    return HRESULTCustomer.Microsoft;
            }
        }
        */
        /// <summary>
        ...
        /// <returns></returns>
        public static implicit operator Int32(HRESULT result)
        {
            return result.value;
        }
        ...
        public override String ToString()
        {
            ...
            if (!dirCodes.TryGetValue(value, out fi))
            {
        ...
        #region IComparable<HRESULT> Members
        ...
        public const int ERROR_SUCCESS = unchecked((int)0x00070000);
